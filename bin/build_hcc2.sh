...
MYCMAKEOPTS="-DCMAKE_BUILD_TYPE=$BUILD_TYPE -DCMAKE_INSTALL_PREFIX=$INSTALL_DIR -DLLVM_ENABLE_ASSERTIONS=ON -DLLVM_TARGETS_TO_BUILD=AMDGPU;X86;NVPTX;PowerPC;AArch64 $COMPILERS -DLLVM_VERSION_SUFFIX=_HCC2_Version_$HCC2_VERSION_STRING -DBUG_REPORT_URL='https://github.com/ROCm-Developer-Tools/hcc2'"
