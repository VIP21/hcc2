#/bin/bash
#
#  build-deb-hcc2.sh:  Using debhelper and alien, build the hcc2 debian and rpm packages
...
#                      A complete build of hcc2 in /opt/rocm/hcc2_$HCC2_VERSION_STRING
...
echo "opt/rocm/$dirname opt/rocm/hcc2" > $froot/debian/$pkgname.links
